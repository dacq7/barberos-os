...
const NAV_ITEMS = [
  { to: '/barbero/agenda', label: 'Agenda' },
  { to: '/barbero/ganancias', label: 'Ganancias' },
  { to: '/barbero/inventario', label: 'Inventario' },
] as const
    ...
    <div className="flex min-h-screen bg-neutral-950">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between px-6 shrink-0">
          <span className="text-sm text-neutral-400">Barbero</span>

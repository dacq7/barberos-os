...
import { loginBarbero } from '../../services/auth.service'
...
export default function BarberoLogin() {
  ...
  const onSubmit = async (values: FormValues) => {
    setServerError(null)
    try {
      const tokenRes = await loginBarbero(values.email, values.password)
      ...
      login(tokenRes.access_token, 'barbero', user)
    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-neutral-400 text-sm">Acceso para barberos</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="barbero@barberos.com"
                {...register('email', {
